...
1.
    ...
    python src/main.py
    ```
   Следуйте инструкциям в интерфейсе стандартного вывода:
    ```
   ...
   Программа: Отсортировать по датам? Да/нет
   ...
   Пользователь:Открытие
   
   2020-08-31T00:52:19Z Открытие вклада
   Счет **5859
   Сумма: 14438.0
   
   2020-11-12T21:50:44Z Открытие вклада
   Счет **7451
   Сумма: 31742.0
   
   2020-11-18T12:07:03Z Открытие вклада
   Счет **3179
   Сумма: 13249.0
